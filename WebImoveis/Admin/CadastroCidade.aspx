<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Admin.Master" CodeBehind="CadastroCidade.aspx.vb" Inherits="WebImoveis.CadastroCidade" Theme="TemaPrincipal"%>
...
<div id="posts">
        <div class="post">
            <h2 class="title">
                Casdastro de Cidades</h2>
            <div class="story">
                <div>
                    Selecione Estado: <asp:DropDownList runat="server" ID="ddlEstadoConsulta" AutoPostBack="true"></asp:DropDownList>
                    <br />
                </div>
                <asp:MultiView runat="server" ID="mtPrincipal" ActiveViewIndex="0">
                    <asp:View runat="server" ID="vwConsulta">
                        <asp:GridView ID="gvCidade" runat="server" ShowFooter="False" AutoGenerateColumns="False" Width="400px"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Estado" DataField="EstadoSigla" />
                            </Columns>
                        </asp:GridView>
                        <br />
